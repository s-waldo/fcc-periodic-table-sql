...
--
-- Name: elements unique_input_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_input_name UNIQUE (name);


--
-- Name: elements unique_input_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_input_symbol UNIQUE (symbol);
